...
* [ ] 坡度圖點擊後，不顯示 dialog，直接在表格區新增內容，預設寫入距離、坡度(%)，備註留空
* [ ] 載入路線後，系統自動為較難爬坡點預先標記並寫入表格區，格式如 24k 6% 200m
* [ ] 取消 EditDialog 流程，改為使用者直接在表格內編輯
* [ ] 表格內容依距離由小到大排序
* [ ] 使用者修改距離後，地圖與坡度圖上的對應標記位置同步更新
* [ ] 表格最下方提供新增按鈕，點擊可新增空白列
* [ ] 每列提供刪除按鈕，點擊後跳出 confirm，確認後刪除該列
